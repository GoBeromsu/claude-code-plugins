...
If yes: save to an appropriate location chosen by the user. Suggested naming: `YYYY-MM-DD first-principles [topic].md`. Create the note with sections: 문제 정의 / 가정 목록 / 근본 요소 / 재구성 방안.
